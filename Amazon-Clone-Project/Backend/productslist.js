const products = [
    {
       ...
       "image_small": "../images/product_0_small.jpg",
       "attribute": "Paperback",
       "categoery" : "Deals",
     ...
     },
    {
     ...
     },
      {
       ...
       "image_small": "../images/product_11_small.jpg",
       "attribute": "iPad",
       "categoery" : "Computers",
     ...
     },
      {
       ...
       "categoery" : "Home",
       "image_small": "../images/product_12_small.jpg",
       "attribute": "Deals",
      ...
      {
       "id": 13,
       "title": "Apple iPhone 14 Pro - Deep Purple",
       "image": "../images/product_13.jpg",
       "image_small": "../images/product_13_small.jpg",
       "attribute": "Mobile",
       "categoery" : "Mobiles",
   ...
   const filtredProducts = products.filter((ele)=>ele.categoery === "Deals")
