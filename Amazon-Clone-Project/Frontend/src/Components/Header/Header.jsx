...
const Header = () => {
  ...
  const defaultUserLocation = userLocation.length>0 && userLocation.find((location)=>location?.default === true);

  return (
    <div>
      <header className='overflow-visible h-25  grid relative pt-3 w-full'> 
        <div className='flex overflow-visible h-22  items-center justify-evenly'>{/* bg-gray-900*/}
          ...
          <div>
          <div className='search--div relative h-full rounded-md ml-3 hidden sm:flex'>
