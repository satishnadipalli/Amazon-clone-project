...
import {LocationIcon, LocationIcons} from '../../HeroIcons'
import CategoeryHeader from './categoeryHeader';
import LeftDetail from './LeftDetail';
import {calculateEMI,ratingImage,percentageCalculator} from './Functions'
...
useEffect(() => {
  fetchData("../public/data/products.json")
    .then(data => {
