...
const CatProductGen = ({element}) => {
	const {image,price,oldPrice,avgRating,ratings,description,_id,categoery} = element
	
  return (
	<Link to={`/ontwoproduct/${_id}`}>
		
		<div key={_id} className='text-black w-52 align-top shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] h-full  relative p-4'>
			<img src={"http://localhost:3000/uploads/"+image} alt="max-h-10" className='pb-2 max-h-24'/>
