...
const LeftDetail = ({price,id}) => {
    ...
    function handleImprove({data,id}){
    ...
    <>             
        <div className=' w-64 border border-gray-300 mr-10 pl-5 pr-5 h-full pb-10' style={{borderWidth:'0.01em'}}>
            <div className='relative'>
                ...
                <button className='w-full mt-3 text-sm rounded-full bg-yellow-400 h-7 font-semibold hover:bg-yellow-500' onClick={()=>handleImprove({data,id})}>Add to Cart</button>
